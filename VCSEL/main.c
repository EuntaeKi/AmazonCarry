...
int main(void)
{
  ...
  // attempt to initialize it with the necessary settings for normal operation
  ...
  //  VcselPeriodPreRange:  12 to 18 (initialized default: 14)
  ...
  while (1)
  {
    dist = readRangeContinuousMillimeters(&sensor1);
    printf("%" PRIu16 "\n", dist);
    sprintf(txData, "%d", dist);
